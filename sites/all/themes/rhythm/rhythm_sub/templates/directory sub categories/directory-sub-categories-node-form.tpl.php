...
<div class="bg-white">
	...
	<?php else: ?>
		<br>
		<br>
		<h1 class="uppercase letter-spacing-3 align-center no-margin">Directory Sub Categories Page</h1>
		<br>
		<br>
	<?php endif; ?>
	<div class="container">
		<div class="row clearfix">
			<div class="col-md-offset-1 col-md-10">
				<div class="bg-light-grey border-radius-3 padding-15">
					<h3 class="no-margin uppercase">Main Information</h3>
					<br>
				...
				<br>
				<div class="bg-light-grey border-radius-3 padding-15">
					<h3 class="no-margin uppercase">Area Details</h3>
					<br>
				...
				<div>
					...
					<br>
					<?php print render($form['field_redirect_to_other_page']); ?>
