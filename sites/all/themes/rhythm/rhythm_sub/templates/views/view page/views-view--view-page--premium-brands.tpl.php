			...
			<ul class="bg-white uppercase custom-nav-bars nav nav-tabs align-center font-size-12 no-padding" role="tablist">
				...
				<?php if(!empty($items)): ?>
					...
					<?php if (in_array_r("9", $items)): ?>
						<li class="active"><a href="<?php print  $base_url . '/' . $path . '/premium-brands' ;?>">Best Brands</a></li>
					<?php endif; ?>
	...
	<div class="container">
		...
		<div class="row clearfix row-eq-height">
			<div class="col-12 col-sm-12 col-xs-12 col-md-12 col-lg-12 col-xl-12">
				<?php if((!empty($node->field_premium_title)) || (!empty($node->field_premium_description))) : ?>
					<div class="bg-white no-padding-bottom border-radius-3 box-shadow">
						<?php if(!empty($node->field_premium_title)): ?>
							<?php $title_field = trim(render($node->field_premium_title['und']['0']['value'])); ?>
							<?php
						...
						<?php endif; ?>
						<?php if(!empty($node->field_premium_description)): ?>
							<?php $description_field = trim(render($node->field_premium_description['und'][0]['value'])); ?>
							<?php
				...
				<?php endif; ?>
				<?php
					$block = module_invoke('views', 'block_view', 'directory-premium_pro_directory');
					if ($block):
				?>
					...
					<br>
				<?php endif; ?>
				<?php if(!empty($node->field_premium_middle_content)): ?>
					<div class="bg-white border-radius-3 box-shadow">
						<?php $middle_content_field = trim(render($node->field_premium_middle_content['und'][0]['value'])); ?>
						<?php
				...
				<br>
				<br>
				<?php if(!empty($node->field_premium_lower_content)): ?>
					<div class="bg-white border-radius-3 box-shadow">
						<?php $lower_content_field = trim(render($node->field_premium_lower_content['und'][0]['value'])); ?>
						<?php
