...
function initPageSliders(){
    (function($){
        ...
        $(".menu-item-full-carousel").each(function() {
            var autoplay = $(this).closest('.slider-wrapper').data('autoplay')
            $(this).owlCarousel({
                autoPlay: autoplay ? autoplay : false,
                rewind: true,
        ...
        $(".menu-item-short-carousel").each(function() {
            var autoplay = $(this).closest('.slider-wrapper').data('autoplay')
            $(this).owlCarousel({
                rewind: true,
                nav: false,
        ...
        $(".custom-item-carousel").each(function() {
            var autoplay = $(this).closest('.slider-wrapper').data('autoplay')
            $(this).owlCarousel({
                rewind: true,
                nav:true,
        ...
        $(".single-carousel").owlCarousel({
         ...
         // Single carousel Auto Slide
        $(".single-carousel-auto-slide").owlCarousel({
            singleItem:true,
            items:1,
            nav:true,
            navElement: 'div',
